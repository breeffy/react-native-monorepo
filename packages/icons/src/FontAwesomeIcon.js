...
import { configureLogger } from '@breeffy/utils';

const log = configureLogger('jest-tests');
...
export default function FontAwesomeIcon(props) {
  ...
  const secondaryOpacity =
    props.secondaryOpacity || (secondaryColor ? 1 : DEFAULT_SECONDARY_OPACITY);
  ...
  if (height || width) {
    if (size) {
      console.warn(
        `DEPRECATION: height and width props on ${FontAwesomeIcon.displayName} have been deprecated.  ` +
